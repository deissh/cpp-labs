// Кудявцев К. А. ИПБ-20; 3.8 #9

/*
Задача 9.
Реализовать подпрограмму, удаляющую в кольцевом списке все элементы, которые больше своих соседей.
 */
...
int main() {
    ...
    while (ref != nullptr and ref->next != nullptr) {
        if (ref->data > ref->next->data and ref->data > ref->prev->data)
            pop(ref);
